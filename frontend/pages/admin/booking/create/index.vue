  ...
  <adminLayout>
    <div class="card-container">
      <div class="title-card">
        <h3 class="text-title">Tạo bàn</h3>
      </div>
      <!--  -->
      <inputBook @getValue="valueInput" />
      <!--  -->
      <div class="line"></div>
      <!--  -->
...
<script>
import inputBook from "~/components/admin/booking/create/inputBook.vue";
...
export default {
  ...
  methods: {
    ...
    valueInput(value = {}) {
      this.dataBook.name_book = value.name_book;
      this.dataBook.note_book = value.note_book;
    },
    ...
    async handleSave() {
      ...
      if (check) {
        ...
        const response = await this.$axios.post(
          url + "/book/create-booking/create",
          {
